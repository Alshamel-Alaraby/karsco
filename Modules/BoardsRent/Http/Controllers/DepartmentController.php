...
use Modules\BoardsRent\Entities\Department;
use Modules\BoardsRent\Http\Requests\DepartmentRequest;
use Modules\BoardsRent\Transformers\DepartmentResource;
...
class DepartmentController extends Controller
{
    ...
    public function create(DepartmentRequest $request)
    {
        ...
        return responseJson(200, 'created', new DepartmentResource($model));
    ...
    public function update($id, DepartmentRequest $request)
    {
        ...
        return responseJson(200, 'updated', new DepartmentResource($model));
    }
