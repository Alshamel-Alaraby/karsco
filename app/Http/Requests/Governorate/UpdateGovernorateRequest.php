...
class UpdateGovernorateRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'string|max:255|unique:general_governorates,name',
            'name_e' => 'string|max:255|unique:general_governorates,name_e',
            'name' => 'string|max:255|unique:general_governorates,name,'.$this->id,
            'name_e' => 'string|max:255|unique:general_governorates,name_e,'.$this->id,
