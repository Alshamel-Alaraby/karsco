        ...
        dropZoneFilesAdded(files) {
            ...
            files.forEach((file) => {
                ...
                adminApi.post('/get-s3-url', {
                    ...
                    file.upload.filename = response.data.fileName;
                    file.media = response.data.media;
                    dropZone.dropzone.options.url = response.data.url;
            ...
            <div class="col-12">
                            ...
                            <div class="d-flex col-xs-10 col-md-9 col-lg-7" style="font-weight: 500">
                                <div class="d-flex">
                                    ...
                                    <b-dropdown variant="primary" :text="$t('general.workspace')" ref="dropdown"
                                        ...
                                        <b-form-checkbox v-for="node in secondLevelNodes" :key="node.id"
                                    ...
                                    <b-dropdown variant="primary" :text="$t('general.fields')" ref="dropdown"
                                                class="btn-block setting-search m-2">
                                        <b-form-checkbox v-for="field in fields" :key="field.name_e"
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <input class="form-control"
                                                       style="padding-top: 3px; display: inline-block" type="text"
                                                       v-model.trim="from" :placeholder="`${$t('general.from')}`"
                                                       @keyup="getFieldData()"/>
                                            </div>
                                            <div class="col-6">
                                                <input class="form-control"
                                                       style="padding-top: 3px; display: inline-block" type="text"
                                                       v-model.trim="to" @keyup="getFieldData()"
                ...
                ">
                                    <div class="d-inline-block position-relative m-2" style="width: 100%">
                                        <div class="row">
                                            <div class="col-6">
                                                <date-picker @change="getFieldData()" v-model="fromDate" type="date"
                                                             confirm></date-picker>
                                            </div>
                                            <div class="col-6">
                                                <date-picker @change="getFieldData()" v-model="toDate" type="date"
                                                             confirm></date-picker>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <span :class="[
                      ...
                      <i class="fe-search"></i>
                                        ...
                                        <input class="form-control" @input="searchFinished = false"
                                               style="display: block; width: 93%; padding-top: 3px" type="text"
                                               v-model.trim="search"
                        ...
                        'pointer-events':
                          archivesPagination.current_page == 1 ? 'none' : '',
                                            ...
                                            <input type="text" @keyup.enter="getPaginatedArchFiles()"
                            ...
                            <form>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <multiselect @select="getDocumentFields"
                              ...
                              ">
                                                ...
                                                <template v-if="currentDocument">
                                                    <div v-for="(field, index) in nodeFields" :key="field.id"
                                                         class="col-lg-6">
                                                        <div v-if="field.doc_field_id.data_type.name_e == 'DATE'"
                                                             class="form-group">
                                                            ...
                                                            <date-picker v-model="field.value" type="date"
                                                                         confirm></date-picker>
                                                        </div>
                                                        <div v-else-if="
...
" :class="{
  ...
  'is-valid':
    ...
    !$v.nodeFields.$each[index].value.$invalid,
                                                        ...
                                                        <div v-else-if="field.doc_field_id.data_type.name_e == 'TIME'"
                                                             class="form-group">
                                                            <label class="control-label">
                                                                {{
                                                                    $i18n.locale == "ar"
                                                            ...
                                                            <b-form-timepicker
                                                                v-model="field.value"></b-form-timepicker>
                                                        </div>
                                                        <div v-else-if="
                            ...
                            " class="form-group">
                                                            ...
                                                            <date-picker v-model="field.value" confirm
                                                        ...
                                                        <div
                                                            ...
                                                            <input type="number" class="form-control" data-create="9"
                                                                   step="1"
                                                                   v-model="$v.nodeFields.$each[index].value.$model"
                                                                   :class="{
                                  'is-invalid':
                                    ...
                                    !$v.nodeFields.$each[index].value.$invalid,
                                        ...
                                        <b-tab :disabled="!archive_id" :title="$t('general.Uploads')">
                                            ...
                                            <vue-dropzone
                                                ...
                                                v-on:vdropzone-files-added="dropZoneFilesAdded"
                                                v-on:vdropzone-duplicate-file="dropzoneDuplicateFile"
...
">
                        ...
                        <b-modal dialog-class="modal-full-width" id="show-file" :title="$t('general.SHOW_FILE')"
                                 title-class="font-18"
                                 size="lg" body-class="p-4 " :hide-footer="true"
                                                ...
                                                <div class="col-12">
                                                    <div class="d-flex flex-wrap">
                                                        <div
                                                            ...
                                                            <div v-if="photo.mime_type != 'application/pdf'"
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <div class="references border">
                                    <TreeBrowser @nodeExpanded="setChildNodes" @onClick="nodeWasClicked"
                            ...
                            <div class="col-lg-5">
                                <template v-if="archiveFiles.length">
                                    <Files @onDoubleClicked="showFileModal" :archiveFiles="archiveFiles"
