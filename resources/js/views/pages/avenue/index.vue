    ...
    ExportExcel(type, fn, dl) {
          ...
          setTimeout(() => {
              ...
              if (dl) {
                  ...
                  XLSX.writeFile(wb, fn || (('Avanue' + '.' || 'SheetJSTableExport.') + (type || 'xlsx')));
              }
              this.enabled3 = true;
          }, 100);
      }
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      ...
                      <b-form-checkbox  v-if="isVisible('city_id')" v-model="setting.city_id" class="mb-1">
                        {{ getCompanyKey("city") }}
                      </b-form-checkbox>
