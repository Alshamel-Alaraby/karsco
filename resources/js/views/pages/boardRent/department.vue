...
export default {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/boards-rent/department/?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/boards-rent/department/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            adminApi
              .delete(`/boards-rent/department/${id}`)
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
    ...
    AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.errors = {};
        adminApi
          .post(`/boards-rent/department`, { ...this.create, company_id: this.company_id })
          .then((res) => {
    ...
    editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        adminApi
          .put(`/boards-rent/department/${id}`, { name, name_e })
          .then((res) => {
    ...
    log(id) {
      if (this.mouseEnter != id) {
        ...
        this.mouseEnter = id;
        adminApi
          .get(`/boards-rent/department/logs/${id}`)
          .then((res) => {
            let l = res.data.data;
            l.forEach((e) => {
