...
export default {
    ...
    beforeRouteEnter(to, from, next) {
        ...
        return vm.$router.push({ name: "home" });
            ...
            if (vm.$store.state.auth.work_flow_trees.includes('reservation')  || vm.$store.state.auth.work_flow_trees.includes('real estate')) {
                return true;
            } else {
                return vm.$router.push({ name: "home" });
            }
    ...
    data() {
        return {
            ...
            filterSetting: ["salesman_id", "customer_id","payment_plan_id"],
            errors: {},
            isCheckAll: false,
            checkAll: [],
            is_disabled: false,
    ...
    methods: {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.errors = {};
                adminApi
                    .put(`real-estate/reservations/${id}`, this.edit)
                    .then((res) => {
        ...
        async resetModalEdit(id) {
            ...
            this.edit.payment_plan_id = reservation.reservation.id;
            this.errors = {};
        },
        /**
         *  hidden Modal (edit)
                            ...
                            >
                                <div>
                                    ...
                                    >
                                        ...
                                        <b-form-checkbox v-model="setting.payment_plan_id" class="mb-1">
                        ...
                        <div class="table-responsive mb-3 custom-table-theme position-relative">
                            ...
                            <table class="table table-borderless table-hover table-centered m-0">
                                ...
                                <tr>
                                    ...
                                    <th v-if="setting.payment_plan_id">
                                        <div class="d-flex justify-content-center">
                                            <span>{{ getCompanyKey("payment_plan") }}</span>
                                            <div class="arrow-sort">
                                                <i
                                                    class="fas fa-arrow-up"
                                                    @click="
                                ...
                                >
                                    ...
                                    <td v-if="setting.payment_plan_id">
                                        <h5 class="m-0 font-weight-normal">
                                            {{
                                                $i18n.locale == "ar" ? data.payment_plan.name : data.payment_plan.name_e
                                            }}
                                        </h5>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <b-modal
                                            ...
                                            :title="getCompanyKey('reservation_edit_form')"
                                            title-class="font-18"
                                            body-class="p-4"
                                            :ref="`edit-${data.id}`"
                                            :hide-footer="true"
