    ...
    methods: {
        ...
        editSubmit(date) {
            ...
            if (this.$v.edit.$invalid || isTrueDrop) {
                ...
                this.errors = {};
                let opening_balances={
                    opening_balances:this.edit
                }
                adminApi.put(`/recievable-payable/rp_opening_balance/${date}`, opening_balances)
                    .then((res) => {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    :disabled="(create[index].local_credit && create[index].local_credit > 0) ? true :false"
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    :disabled="(create[index].local_debit && create[index].local_debit > 0) ? true :false"
                                                    type="number"
                                                    step="any"
                                                    class="form-control"
