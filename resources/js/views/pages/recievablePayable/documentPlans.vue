...
export default {
    ...
    beforeRouteEnter(to, from, next) {
        ...
        return vm.$router.push({ name: "home" });
            ...
            if (vm.$store.state.auth.work_flow_trees.includes('store') || vm.$store.state.auth.work_flow_trees.includes('receivable payable') || vm.$store.state.auth.user.type == 'super_admin') {
                return true;
            } else {
                return vm.$router.push({ name: "home" });
            }
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi
                .get(
                    `/recievable-payable/rp_document_plan?page=${page}&per_page=${this.per_page}&company_id=${this.company_id}&search=${this.search}&${filter}`
                )
                .then((res) => {
                    let l = res.data;
        ...
        getDataCurrentPage(page = 1) {
            if (
                ...
                adminApi
                    .get(
                        `/recievable-payable/rp_document_plan?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}&company_id=${this.company_id}`
                    )
                    .then((res) => {
                        let l = res.data;
                        this.documentPlans = l.data;
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                adminApi
                    .post(`/recievable-payable/rp_document_plan`, data)
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                adminApi
                    .put(`/recievable-payable/rp_document_plan/${id}`, data)
                    .then((res) => {
        ...
        async resetModalEdit(id) {
            await this.getBranch();
            let branch = this.documentPlans.find((e) => id == e.id);
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title">{{ $t("store.documentPlansTable") }}</h4>
                          ...
                          'pointer-events':
                            documentPlansPagination.current_page == 1 ? 'none' : '',
                                            ...
                                            <a
                                                ...
                                                :style="{
                          'pointer-events':
                            documentPlansPagination.last_page == documentPlansPagination.current_page
                              ? 'none'
                              : '',
                        }"
                                                @click.prevent="getData(documentPlansPagination.current_page + 1)"
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i
                                                    ...
                                                    @click="documentPlans.sort(sortString('name'))"
                                                ></i>
                                                <i
                                    ...
                                    <th v-if="setting.name_e">
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i
                                                    class="fas fa-arrow-up"
                                                    @click="documentPlans.sort(sortString('name_e'))"
                                                ></i>
                                                <i
                                                    class="fas fa-arrow-down"
                                                    @click="documentPlans.sort(sortString('-name_e'))"
