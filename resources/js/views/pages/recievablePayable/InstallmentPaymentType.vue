...
">
                        ...
                        <!--  create   -->
                        <b-modal id="create" size="lg" :title="getCompanyKey('installment_payment_type_create_form')"
                                 title-class="font-18"
                        ...
                        'is-valid':
                          ...
                          !errors.is_conditional,
                                                ...
                                                <b-form-radio class="d-inline-block"
                                                              ...
                                                              name="some-radios-create-is_conditional" value="1">
                                                    {{ $t("general.Yes") }}
                                                </b-form-radio>
                                                <b-form-radio class="d-inline-block m-1"
                                                              v-model="$v.create.is_conditional.$model"
                                                              name="some-radios-create-is_conditional" value="0">
                                                    {{ $t("general.No") }}
                                                </b-form-radio>
                                            </b-form-group>
                                            <template v-if="errors.is_conditional">
                                                <ErrorMessage v-for="(errorMessage, index) in errors.is_conditional"
                                                              :key="index">{{
                                                        errorMessage
                                                    }}
                                                </ErrorMessage>
  ...
  'is-invalid':
    $v.create.Condition_id.$error || errors.Condition_id,
                                                ...
                                                <template v-if="errors.condition_id">
                                                    <ErrorMessage v-for="(errorMessage, index) in errors.condition_id"
                                                                  :key="index">{{
                                                            errorMessage
                                                        }}
                                                    </ErrorMessage>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <b-form-group id="edit-11" :class="{
                                                'is-invalid':
                                                  $v.create.installmentPaymentType_freq.$error || errors.installmentPaymentType_freq,
                                                'is-valid':
                                                ...
                                                <b-form-radio class="d-inline-block"
                                                              ...
                                                              name="installmentPaymentType_freq" value="1">
                                                    {{ $t("general.Yes") }}
                                                </b-form-radio>
                                                <b-form-radio class="d-inline-block m-1"
                                                              v-model="$v.create.installmentPaymentType_freq.$model"
                                                              name="installmentPaymentType_freq" value="0">
                                                    {{ $t("general.No") }}
                                                </b-form-radio>
                                            </b-form-group>
                                            <template v-if="errors.installmentPaymentType_freq">
                                                <ErrorMessage
                                                    v-for="(errorMessage, index) in errors.installmentPaymentType_freq"
                                                    :key="index">{{
                                                        errorMessage
                                                    }}
                                                </ErrorMessage>
                                            ...
                                            <div class="form-group">
                                              ...
                                              'is-valid':
                                                ...
                                                <template v-if="errors.Freq_period">
                                                    <ErrorMessage v-for="(errorMessage, index) in errors.Freq_period"
                                                                  :key="index">{{ errorMessage }}
                                                    </ErrorMessage>
                                                </template>
                                            </div>
                        ...
                        'is-valid':
                          !$v.create.is_partially.$invalid && !errors.is_partially,
                                                ...
                                                <b-form-radio class="d-inline-block"
                                                              ...
                                                              name="some-radios-is_partially" value="1">
                                                    {{ $t("general.Yes") }}
                                                </b-form-radio>
                                                <b-form-radio class="d-inline-block m-1"
                                                              v-model="$v.create.is_partially.$model"
                                                              name="some-radios-is_partially" value="0">
                                                    {{ $t("general.No") }}
                                                </b-form-radio>
                                            </b-form-group>
                                            <template v-if="errors.is_partially">
                                                <ErrorMessage v-for="(errorMessage, index) in errors.is_partially"
                                                              :key="index">{{ errorMessage }}
                                                </ErrorMessage>
                                            </template>
                                        </div>
                        ...
                        'is-valid':
                          !$v.create.is_passed.$invalid && !errors.is_passed,
                                                ...
                                                <b-form-radio class="d-inline-block"
                                                              ...
                                                              name="some-radioscreate-is_passed" value="1">
                                                    {{ $t("general.Yes") }}
                                                </b-form-radio>
                                                <b-form-radio class="d-inline-block m-1"
                                                              v-model="$v.create.is_passed.$model"
                                                              name="some-radioscreate-is_passed" value="0">
                                                    {{ $t("general.No") }}
                                                </b-form-radio>
                                            </b-form-group>
                                            <template v-if="errors.is_passed">
                                                <ErrorMessage v-for="(errorMessage, index) in errors.is_passed"
                                                              :key="index">{{ errorMessage }}
                                                </ErrorMessage>
                                            </template>
                                        </div>
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up"
                                                   @click="installmentPayments.sort(sortString('name'))"></i>
                                    ...
                                    <th v-if="setting.name_e">
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up"
                                                   @click="installmentPayments.sort(sortString('name_e'))"></i>
                                                <i class="fas fa-arrow-down"
                                                   @click="installmentPayments.sort(sortString('-name_e'))"></i>
                                            </div>
                                        </div>
                        ...
                        <span>{{
                                ...
                                <tr @click.capture="checkRow(data.id)"
                                    ...
                                    <td v-if="enabled3 && data.id > 1" class="do-not-print">
                                        <div class="btn-group">
                                        ...
                                        <!--  edit   -->
                                        <b-modal size="lg" :id="`modal-edit-${data.id}`"
                                                    ...
                                                    <template v-if="edit.is_conditional == 1">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <multiselect @input="showConditionModal"
  ...
  'is-invalid':
    $v.edit.Condition_id.$error || errors.Condition_id,
                                                                ...
                                                                <div v-if="!$v.edit.Condition_id.required"
                                                                     class="invalid-feedback">
                                                                    {{ $t("general.fieldIsRequired") }}
                                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <b-form-group id="edit-11" :class="{
                                                                'is-invalid':
                                                                  $v.edit.installmentPaymentType_freq.$error || errors.installmentPaymentType_freq,
                                                                'is-valid':
                                                                ...
                                                                <b-form-radio class="d-inline-block"
                                                                              ...
                                                                              value="1">{{ $t("general.Yes") }}
                                                                </b-form-radio>
                                                                <b-form-radio class="d-inline-block m-1"
                                                                              v-model="$v.edit.installmentPaymentType_freq.$model"
                                                                              name="some-radios-installmentPaymentType_freq"
                                                                              value="0">{{ $t("general.No") }}
                                                                </b-form-radio>
                                                            </b-form-group>
                                                            <template v-if="errors.installmentPaymentType_freq">
                                                                <ErrorMessage
