...
export default {
    ...
    beforeRouteEnter(to, from, next) {
        ...
        next((vm) => {
            if (vm.$store.state.auth.work_flow_trees.includes('installment payment type') || vm.$store.state.auth.work_flow_trees.includes('receivable payable')) {
            return true;
            } else {
                return vm.$router.push({ name: "home" });
            }
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi.get(`/recievable-payable/rp_installment_payment_types?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`)
                .then((res) => {
                    let l = res.data;
            ...
            if (Array.isArray(id)) {
                Swal.fire({
                    ...
                    if (result.value) {
                        this.isLoader = true;
                        adminApi
                            .post(`/recievable-payable/rp_installment_payment_types/bulk-delete`, { ids: id })
                            .then((res) => {
                                this.checkAll = [];
                                this.getData();
                                Swal.fire({
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.post(`/recievable-payable/rp_installment_payment_types`, this.create)
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.put(`/recievable-payable/rp_installment_payment_types/${id}`, this.edit)
                    .then((res) => {
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title"> {{ $t('general.installmentPaymentTypeTable') }}</h4>
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:13px;">
                                            {{ installmentPaymentsPagination.from }}-{{ installmentPaymentsPagination.to }} /
                                            {{ installmentPaymentsPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':installmentPaymentsPagination.current_page == 1 ? 'none': ''}"
                                                @click.prevent="getData(installmentPaymentsPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':installmentPaymentsPagination.last_page == installmentPaymentsPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(installmentPaymentsPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
                            ...
                            <form>
                                ...
                                <div class="row">
                                  ...
                                  "
                                                ...
                                                :class="{
                                    'is-invalid':
                                      $v.create.auto_freq.$error || errors.auto_freq,
                                    'is-valid':
                                      !$v.create.auto_freq.$invalid &&
                                      !errors.auto_freq,
                                  }"
                                            >
                            ...
                            <table class="table table-borderless table-hover table-centered m-0">
                                ...
                                <tr>
                                    ...
                                    <th v-if="setting.name_e">
                                        <div class="d-flex justify-content-center">
                                            <span>{{ getCompanyKey('installment_payment_type_name_e') }}</span>
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up"
                                    ...
                                    <th v-if="setting.is_partially">
                                        <div class="d-flex justify-content-center">
                                            <span>{{ getCompanyKey('installment_payment_is_partially') }}</span>
                                        </div>
                                    </th>
                                    <th>
                                        {{ $t('general.Action') }}
                                ...
                                >
                                    ...
                                    <td v-if="setting.auto_freq">
                                        ...
                                        >
                                            {{ data.auto_freq == 1 ? `${$t('general.Active')}` : `${$t('general.Inactive')}` }}
                                        </span>
                                    </td>
                                    <td v-if="setting.is_partially">
                                        ...
                                        >
                                            {{ data.is_partially == 1 ? `${$t('general.Active')}` : `${$t('general.Inactive')}` }}
                                        </span>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                              ...
                                                              "
                                                                ...
                                                                :class="{
                                                                'is-invalid':
                                                                  $v.edit.auto_freq.$error ||
                                                                  errors.auto_freq,
                                                                'is-valid':
                                                                  !$v.edit.auto_freq.$invalid &&
                                                                  !errors.auto_freq,
                                                              }"
                                                            >
                                                                <option value="" selected>
                                ...
                                <tbody v-else>
                                <tr>
                                    <th class="text-center" colspan="9">{{ $t('general.notDataFound') }}</th>
                                </tr>
                                </tbody>
                            </table>
