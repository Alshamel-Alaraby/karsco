...
export default {
    ...
    data() {
        return {
            ...
            filterSetting: ['name', 'name_e','description','description_e','installment_payment_type_id'],
            Tooltip: '',
            mouseEnter: null,
        }
    },
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi.get(`/recievable-payable/rp_installment_p_plan?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`)
                .then((res) => {
                    let l = res.data;
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.post(`/recievable-payable/rp_installment_p_plan`, this.create)
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                adminApi.put(`/recievable-payable/rp_installment_p_plan/${id}`, {name, name_e, is_default})
                    .then((res) => {
        ...
        resetModalEdit(id) {
            ...
            this.installment_payment_type_id = module.installment_payment_type_id;
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title"> {{ $t('general.installmentPaymentPlanTable') }}</h4>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                v-model="$v.create.installment_payment_type_id.$model"
                                                :class="{
                                                'is-invalid':$v.create.installment_payment_type_id.$error || errors.installment_payment_type_id,
                                                'is-valid':!$v.create.installment_payment_type_id.$invalid && !errors.installment_payment_type_id
                                            }"
                                            />
                                            <template v-if="errors.installment_payment_type_id">
                                                <ErrorMessage v-for="(errorMessage,index) in errors.installment_payment_type_id" :key="index">{{ errorMessage }}</ErrorMessage>
                                            </template>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                v-model="$v.edit.installment_payment_type_id.$model"
                                                                :class="{
                                                                    'is-invalid':$v.edit.installment_payment_type_id.$error || errors.installment_payment_type_id,
                                                                    'is-valid':!$v.edit.installment_payment_type_id.$invalid && !errors.installment_payment_type_id
                                                                }"
                                                            />
                                                            <template v-if="errors.installment_payment_type_id">
                                                                <ErrorMessage v-for="(errorMessage,index) in errors.installment_payment_type_id" :key="index">{{ errorMessage }}</ErrorMessage>
