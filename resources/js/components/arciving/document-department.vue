...
export default {
    ...
    methods: {
        ...
        async getData(page = 1) {
            this.isLoader = true;
            await adminApi.get(`/arch-doc-type-department/getDepartmentByDocument/${this.arch_doc_type_id}`)
                .then((res) => {
                    let l = res.data;
        ...
        async getDepartment() {
            await adminApi
                ...
                .then((res) => {
                    let l = res.data.data;
                    l.unshift({id: 0, name: "Add Arch Department", name_e: "Add Arch Department"});
