...
export default {
  ...
  mixins: [transMixinComp],
    ...
    props: ["arch_doc_type_id", "doc_type_field","document_data","companyKeys", "defaultsKeys"],
    components: {
        Layout,
        ErrorMessage,
        loader,
    ...
    methods: {
        ...
        showDocFieldModalEdit(index) {
            ...
            if (this.edit[index].doc_field_id == 0) {
                ...
                if(
                    ...
                    this.edit[index].field_characters = 'h:mm tt';
                }
                if(
                    this.archDocFieldData.find(el => el.id == this.edit[index].doc_field_id)
                        .data_type.name_e == 'TIMESTAMP'
                ){
                    this.edit[index].field_characters = 'dd-mm-yyyy h:mm tt';
                }
                if(
                    this.archDocFieldData.find(el => el.id == this.edit[index].doc_field_id)
                        .data_type.name_e == 'BOOLEAN'
                ){
                    this.edit[index].field_characters = 'True And False';
                }
            }
        },
        ...
        orderDropChange(index){
            let fill = this.edit.filter((el,ind) => index != ind && el.doc_field_id == this.edit[index].doc_field_id)
            if(fill.length > 0){
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <multiselect
                                            ...
                                            :class="{
                                                  'is-invalid':
                                                    $v.edit.$each[index].doc_field_id.$error || errors.doc_field_id || !allDrop[index].order,
                                                  'is-valid':
                                                    !$v.edit.$each[index].doc_field_id.$invalid && !errors.doc_field_id && allDrop[index].order,
                                                }"
                                        >
                                        </multiselect>
