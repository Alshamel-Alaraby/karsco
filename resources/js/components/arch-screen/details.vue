  ...
  <div>
      <div class="row details mt-2" v-if="$store.state.archiving.archiveFile.length == 1">
          <div class="col-md-12 mt-2">
              <div class="row justify-content-center align-items-center details-img position-relative">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <input
                                      ...
                                      type="number"
                                      class="form-control"
                                      :class="{'is-invalid': $v.watsApp.phone.$error,'is-valid':!$v.watsApp.phone.$invalid,}"
                                      data-create="9"
                                  />
                              </div>
                          </div>
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <input
                                      ...
                                      class="form-control"
                                      data-create="9"
                                      :class="{'is-invalid': $v.sendEmail.email.$error,'is-valid':!$v.sendEmail.email.$invalid,}"
                                  />
                              </div>
                          </div>
                      </div>
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <input
                                      type="text"
                                      disabled
                                      :value="$store.state.archiving.objectActive.media[$store.state.archiving.objectActive.media.length -1].url"
                                      class="form-control"
                                      data-create="9"
                                  />
                              </div>
              ...
              <div class="details-nav">
                  <div class="d-flex justify-content-between">
                      <div class="col-8">
                          ...
                          <span class="btn-action-cutom" @click.prevent="$bvModal.show('show-whatup')">
                              <i class="fab fa-whatsapp"></i>
                          </span>
                          <span class="btn-action-cutom" @click.prevent="$bvModal.show('show-notify')">
                              <i class="fe-bell noti-icon"></i>
                          </span>
                      </div>
                      <div class="col-2">
                      <span class="btn-action-cutom" @click.prevent="deleteFile($store.state.archiving.objectActive.id)">
    ...
    methods: {
        ...
        getLinkWhastapp() {
            ...
            if (this.$v.watsApp.$invalid) {
                ...
                + this.watsApp.phone
                + '&text='
                + encodeURIComponent(this.$store.state.archiving.objectActive.media[this.$store.state.archiving.objectActive.media.length -1].url)
