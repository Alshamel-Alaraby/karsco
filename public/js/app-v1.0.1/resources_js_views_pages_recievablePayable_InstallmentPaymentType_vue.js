  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/recievable-payable/rp_installment_payment_types?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this3.installmentPayments = l.data;
        _this3.installmentPaymentsPagination = l.pagination;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/recievable-payable/rp_installment_payment_types", this.create).then(function (res) {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/recievable-payable/rp_installment_payment_types/".concat(id), this.edit).then(function (res) {
                              ...
                              _c("div", { staticClass: "d-inline-block" }, [
                                _c(
                                  "a",
                                  {
                                    style: {
                                      "pointer-events":
                                        _vm.installmentPaymentsPagination
                                          .current_page == 1
                                          ? "none"
                                          : "",
                                    },
                  ...
                  "b-modal",
                  {
                    attrs: {
                      ...
                      title: _vm.getCompanyKey(
                        "installment_payment_type_create_form"
                      ),
                      "title-class": "font-18",
                      "body-class": "p-4 ",
                      "hide-footer": true,
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.$v.create.auto_freq.$model,
                                      expression: "$v.create.auto_freq.$model",
                                    },
                                  ],
                                  staticClass: "custom-select mr-sm-2",
                                  class: {
                                    "is-invalid":
                                      _vm.$v.create.auto_freq.$error ||
                                      _vm.errors.auto_freq,
                                    "is-valid":
                                      !_vm.$v.create.auto_freq.$invalid &&
                                      !_vm.errors.auto_freq,
                                  },
                                  attrs: { id: "field-11", "data-create": "8" },
                                  on: {
                                    keypress: function ($event) {
                                      if (
                                        !$event.type.indexOf("key") &&
                            ...
                            [
                              ...
                              _c(
                                "select",
                                {
                                  ...
                                  attrs: { id: "field-12", "data-create": "8" },
                                  on: {
                                    keypress: function ($event) {
                                      if (
                                        !$event.type.indexOf("key") &&
                  ...
                  [
                    ...
                    _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _vm.installmentPayments.length > 0
                          ? _c(
                              "tbody",
                              _vm._l(
                                _vm.installmentPayments,
                                function (data, index) {
                                  return _c(
                                    "tr",
                                    {
                                          ...
                                          _c(
                                            "b-modal",
                                            {
                                              ...
                                              attrs: {
                                                ...
                                                title: _vm.getCompanyKey(
                                                  "installment_payment_type_edit_form"
                                                ),
                                                "title-class": "font-18",
                                                "body-class": "p-4",
                                                "hide-footer": true,
