...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      ...
      } else if (vm.showScreen("area", "country") && vm.$store.state.auth.work_flow_trees.includes("area") || vm.$store.state.auth.user.type == "super_admin") {
        return true;
      } else {
        return vm.$router.push({
          name: "home"
  ...
  validations: {
    create: {
      ...
      short_code: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_11__.required,
        alpha: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_11__.alpha,
  ...
  methods: {
    ...
    longArabicValue: function longArabicValue(txt) {
      this.create.long_name = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_10__.arabicValue)(txt);
      this.edit.long_name = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_10__.arabicValue)(txt);
    },
    longEnglishValue: function longEnglishValue(txt) {
      this.create.long_name_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_10__.englishValue)(txt);
      this.edit.long_name_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_10__.englishValue)(txt);
    },
    showScreen: function showScreen(module, screen) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    }, [_vm._v("\n            " + _vm._s(_vm.$t(item.label)) + "\n          ")]) : _vm._e(), _vm._v(" "), !item.isTitle && !item.isLayout && (_vm.workFlowTree.includes(item.name) || _vm.$store.state.auth.user.type == "super_admin") ? _c("li", {
      key: item.id
