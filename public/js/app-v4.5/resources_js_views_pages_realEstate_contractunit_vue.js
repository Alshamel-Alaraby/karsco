...
var render = function render() {
  ...
  return _c("Layout", [_c("PropertyTree", {
  ...
  })])]) : _vm._e(), _vm._v(" "), _vm.setting.unit_code ? _c("th", [_c("div", {
  ...
  })]) : _vm._e()])]), _vm._v(" "), _vm.contractUnits.length > 0 ? _c("tbody", _vm._l(_vm.contractUnits, function (data, index) {
    return _c("tr", {
      key: data.id,
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.setting.unit_code ? _c("td", [_c("h5", {
