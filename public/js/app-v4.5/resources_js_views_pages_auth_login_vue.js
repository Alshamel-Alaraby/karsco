    ...
    tryToLogIn: function tryToLogIn() {
      ...
      if (this.$v.$invalid) {
        ...
        if (this.login_as == "admin") {
          axios.post("".concat("http://alshamel-admin.test/", "api/partners/login"), {
            email: _email,
            password: password
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return axios.get("".concat("http://alshamel-admin.test/", "api/everything_about_the_company/").concat(id)).then(function (res) {
                var l = res.data.data;
                var name = [];
