      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _this10.$v.create.$touch();
              if (!_this10.$v.create.$invalid) {
                _context5.next = 3;
                break;
              }
            ...
            case 3:
              _context5.next = 5;
              return _this10.getRoleUsersCount(_this10.create.role_id);
            case 5:
              self = _this10;
              check = _this10.$store.state.auth.allWorkFlow.filter(function (workflow) {
              ...
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "error",
                text: "".concat(_this10.$t("general.ExceedMaxUserNumber")),
                showConfirmButton: false,
                timer: 1500
              });
              return _context5.abrupt("return");
            case 12:
              ...
              _this10.errors = {};
              _this10.create.role_id = _this10.create.role_id;
              _this10.create.workflow_id = _this10.create.workflow_id;
              module = _this10.workflows.find(function (e) {
                return _this10.create.workflow_id == e.id;
              });
              _this10.create.workflow_name = module.name_e;
              _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/role-workflows", _objectSpread(_objectSpread({}, _this10.create), {}, {
                company_id: _this10.company_id
              })).then(function (res) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _this11.$v.edit.$touch();
              if (!_this11.$v.edit.$invalid) {
                _context6.next = 3;
                break;
              }
            ...
            case 3:
              _context6.next = 5;
              return _this11.getRoleUsersCount(_this11.edit.role_id);
            case 5:
              self = _this11;
            ...
            case 12:
              ...
              _this11.errors = {};
              _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/role-workflows/".concat(id), _this11.edit).then(function (res) {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 4:
              ...
              _this12.edit.workflow_name = module.name_e;
          ...
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("user-role/user-count/".concat(id)).then(function (res) {
                _this15.usersCount = res.data.user_count;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.next = 3;
              return axios.get("".concat("http://alshamel-admin.test/", "api/everything_about_the_company/").concat(_this16.company_id)).then(function (res) {
                var l = res.data.data;
                _this16.workflows = l.work_flow_trees;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
