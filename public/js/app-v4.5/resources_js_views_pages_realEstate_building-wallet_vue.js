...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  validations: {
    create: {
      ...
      description: {
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_11__.maxLength)(1000)
      },
      description_e: {
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_11__.maxLength)(1000)
      },
      land_area: {
        ...
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_11__.maxLength)(9)
      },
      building_area: {
        numeric: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_11__.numeric,
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_11__.maxLength)(9)
      ...
      construction_year: {
        ...
        minLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_11__.minLength)(4),
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_11__.maxLength)(4)
      },
      module: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_11__.required
      },
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return navigator.geolocation.getCurrentPosition(_this8.showPosition);
            case 3:
    ...
    arabicValueDescription: function arabicValueDescription(txt) {
      this.create.description = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_7__.arabicValue)(txt);
    },
    ...
    englishValueDescription: function englishValueDescription(txt) {
      this.create.description_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_7__.englishValue)(txt);
    }
  }
});
...
var render = function render() {
  ...
  return _c("b-modal", {
    ...
    model: {
      value: _vm.$v.create.module.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.module, "$model", $$v);
      },
      expression: "$v.create.module.$model"
    }
  }), _vm._v(" "), _vm.$v.create.module.$error || _vm.errors.module ? _c("div", {
    staticClass: "text-danger"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.errors.module ? _vm._l(_vm.errors.module, function (errorMessage, index) {
    ...
    staticClass: "col-md-3 d-flex align-items-center mt-3"
  }, [_c("button", {
