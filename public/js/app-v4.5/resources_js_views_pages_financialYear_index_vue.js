...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.start_date ? _c("td", [_vm._v(_vm._s(_vm.formatDate(data.start_date)))]) : _vm._e(), _vm._v(" "), _vm.setting.end_date ? _c("td", [_vm._v(_vm._s(_vm.formatDate(data.end_date)))]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
