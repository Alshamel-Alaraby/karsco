...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      ...
      } else if (vm.showScreen("area", "avenue") && vm.$store.state.auth.work_flow_trees.includes("area") || vm.$store.state.auth.user.type == "super_admin") {
        return true;
      } else {
        return vm.$router.push({
          name: "home"
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Country", {
    ...
    staticClass: "do-not-print"
  }, [_vm._v(_vm._s(_vm.$t("general.Action")))]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("th", {
    staticClass: "do-not-print"
  }, [_c("i", {
