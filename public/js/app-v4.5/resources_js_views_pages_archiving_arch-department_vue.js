...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    staticClass: "mr-2"
  }, [_vm._v("\n                                            " + _vm._s(_vm.$t("general.is_key")) + "\n                                            "), _c("span", {
    staticClass: "text-danger"
  }, [_vm._v("*")])]), _vm._v(" "), _c("b-form-group", {
    "class": {
      "is-invalid": _vm.$v.create.is_key.$error || _vm.errors.is_key,
      "is-valid": !_vm.$v.create.is_key.$invalid && !_vm.errors.is_key
    }
  }, [_c("b-form-radio", {
    staticClass: "d-inline-block",
    attrs: {
    ...
    model: {
      value: _vm.$v.create.is_key.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.is_key, "$model", $$v);
      },
      expression: "$v.create.is_key.$model"
    }
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.No")) + "\n                                            ")])], 1), _vm._v(" "), _vm.errors.is_key ? _vm._l(_vm.errors.is_key, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage) + "\n                                            ")]);
  }) : _vm._e()], 2)]), _vm._v(" "), _vm.create.is_key == 1 ? _c("div", {
    staticClass: "col-md-12"
  }, [_c("div", {
    staticClass: "form-group"
    ...
    on: {
      input: function input($event) {
        return _vm.showDocFieldModal();
      }
    },
    model: {
      value: _vm.$v.create.key_value.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.key_value, "$model", $$v);
      },
      expression: "$v.create.key_value.$model"
    }
  }), _vm._v(" "), _vm.errors.key_value ? _vm._l(_vm.errors.key_value, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage) + "\n                                            ")]);
  }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), _c("div", {
    ...
    return _c("tr", {
      ...
      "class": {
        "is-invalid": _vm.$v.edit.is_key.$error || _vm.errors.is_key,
        "is-valid": !_vm.$v.edit.is_key.$invalid && !_vm.errors.is_key
      }
    }, [_c("b-form-radio", {
      staticClass: "d-inline-block",
      attrs: {
      ...
      model: {
        value: _vm.$v.edit.is_key.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.is_key, "$model", $$v);
        },
        expression: "$v.edit.is_key.$model"
      }
    }, [_vm._v(_vm._s(_vm.$t("general.Yes")) + "\n                                                            ")]), _vm._v(" "), _c("b-form-radio", {
      staticClass: "d-inline-block m-1",
      attrs: {
    ...
    }) : _vm._e()], 2)]), _vm._v(" "), _vm.edit.is_key == 1 ? _c("div", {
      staticClass: "col-md-12"
    }, [_c("div", {
      staticClass: "form-group"
    }, [_c("label", [_vm._v("\n                                                            " + _vm._s(_vm.getCompanyKey("arch_doc_field")) + "\n                                                            "), _c("span", {
      ...
      on: {
        input: function input($event) {
          return _vm.showDocFieldModalEdit();
        }
      },
      model: {
        value: _vm.$v.edit.key_value.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.key_value, "$model", $$v);
        },
        expression: "$v.edit.key_value.$model"
      }
    }), _vm._v(" "), _vm.errors.key_value ? _vm._l(_vm.errors.key_value, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
