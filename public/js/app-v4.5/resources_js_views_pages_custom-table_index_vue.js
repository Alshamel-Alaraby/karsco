...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    }), _defineProperty(_ref, "company_id", null), _defineProperty(_ref, "errors", {}), _defineProperty(_ref, "isCheckAll", false), _defineProperty(_ref, "checkAll", []), _defineProperty(_ref, "current_page", 1), _defineProperty(_ref, "setting", {
      name: true,
      name_e: true
    }), _defineProperty(_ref, "is_disabled", false), _defineProperty(_ref, "filterSetting", ["name", "name_e"]), _ref;
  },
  validations: {
    create: {
      table_name: {
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/branches?page=".concat(page, "&per_page=").concat(this.per_page, "&company_id=").concat(this.company_id, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        ...
        _this4.customTablesPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.customTablesPagination.last_page && this.current_page != this.customTablesPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/branches?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter, "&company_id=").concat(this.company_id)).then(function (res) {
          ...
          _this5.customTablesPagination = l.pagination;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/branches", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/branches/".concat(id), _objectSpread(_objectSpread({}, this.edit), {}, {
          company_id: this.company_id
        })).then(function (res) {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    staticClass: "sr-only"
  }, [_vm._v(_vm._s(_vm.$t("login.Loading")) + "...")])], 1)], 1), _vm._v(" "), _vm._l(_vm.create.columns, function (item, index) {
    return [_c("div", {
      staticClass: "row"
    }, [_c("div", {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.create.columns.$each[index].name.$model,
        expression: "$v.create.columns.$each[index].name.$model"
      }],
      staticClass: "form-control arabicInput",
      "class": {
        "is-invalid": _vm.$v.create.columns.$each[index].name.$error || _vm.errors.name,
        "is-valid": !_vm.$v.create.columns.$each[index].name.$invalid && !_vm.errors.name
      },
      attrs: {
        type: "text",
        "data-create": "1",
      ...
      on: {
        ...
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.create.columns.$each[index].name, "$model", $event.target.value);
        }
      }
    })]), _vm._v(" "), !_vm.$v.create.columns.$each[index].name.minLength ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.Itmustbeatleast")) + "\n                                " + _vm._s(_vm.$v.create.columns.$each[index].name.$params.minLength.min) + "\n                                " + _vm._s(_vm.$t("general.letters")) + "\n                              ")]) : _vm._e(), _vm._v(" "), !_vm.$v.create.columns.$each[index].name.maxLength ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.Itmustbeatmost")) + "\n                                " + _vm._s(_vm.$v.create.columns.$each[index].name.$params.maxLength.max) + "\n                                " + _vm._s(_vm.$t("general.letters")) + "\n                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.name ? _vm._l(_vm.errors.name, function (errorMessage, index) {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.$v.create.columns.$each[index].name_e.$model,
        expression: "$v.create.columns.$each[index].name_e.$model"
      }],
      staticClass: "form-control englishInput",
      "class": {
        "is-invalid": _vm.$v.create.columns.$each[index].name_e.$error || _vm.errors.name_e,
        "is-valid": !_vm.$v.create.columns.$each[index].name_e.$invalid && !_vm.errors.name_e
      },
      attrs: {
        type: "text",
        "data-create": "2",
      ...
      on: {
        ...
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.$v.create.columns.$each[index].name_e, "$model", $event.target.value);
        }
      }
    })]), _vm._v(" "), !_vm.$v.create.columns.$each[index].name_e.minLength ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.Itmustbeatleast")) + "\n                                " + _vm._s(_vm.$v.create.columns.$each[index].name_e.$params.minLength.min) + "\n                                " + _vm._s(_vm.$t("general.letters")) + "\n                              ")]) : _vm._e(), _vm._v(" "), !_vm.$v.create.columns.$each[index].name_e.maxLength ? _c("div", {
      staticClass: "invalid-feedback"
    }, [_vm._v("\n                                " + _vm._s(_vm.$t("general.Itmustbeatmost")) + "\n                                " + _vm._s(_vm.$v.create.columns.$each[index].name_e.$params.maxLength.max) + "\n                                " + _vm._s(_vm.$t("general.letters")) + "\n                              ")]) : _vm._e(), _vm._v(" "), _vm.errors.name_e ? _vm._l(_vm.errors.name_e, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      }, [_vm._v(_vm._s(errorMessage))]);
    }) : _vm._e()], 2)]), _vm._v(" "), _c("div", {
      ...
      "class": {
        "is-invalid": _vm.$v.create.columns.$each[index].is_required.$error || _vm.errors.is_required,
        "is-valid": !_vm.$v.create.columns.$each[index].is_required.$invalid && !_vm.errors.is_required
      }
    }, [_c("b-form-radio", {
      staticClass: "d-inline-block",
      attrs: {
      ...
      model: {
        value: _vm.$v.create.columns.$each[index].is_required.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.create.columns.$each[index].is_required, "$model", $$v);
        },
    ...
    }) : _vm._e()], 2)]), _vm._v(" "), _vm.create.length > 1 ? _c("div", {
