...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  validations: {
    create: {
      ...
      short_code: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_7__.required,
        alpha: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_7__.alpha,
  ...
  methods: {
    ...
    arabicValueLong: function arabicValueLong(txt) {
      this.create.long_name = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_6__.arabicValue)(txt);
    },
    ...
    englishValueLong: function englishValueLong(txt) {
      this.create.long_name_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_6__.englishValue)(txt);
    }
  }
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      ...
      } else if (vm.showScreen("area", "city") && vm.$store.state.auth.work_flow_trees.includes("area") || vm.$store.state.auth.user.type == "super_admin") {
        return true;
      } else {
        return vm.$router.push({
          name: "home"
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              city = _this12.cities.find(function (e) {
                return id == e.id;
              });
              _context2.next = 3;
            ...
            case 3:
              _context2.next = 5;
              return _this12.getGovernorate(city.country.id);
            case 5:
              _this12.edit.name = city.name;
              _this12.edit.name_e = city.name_e;
              _this12.edit.is_active = city.is_active ? 1 : 0;
              _this12.edit.country_id = city.country.id;
              _this12.edit.governorate_id = city.governorate.id;
              _this12.errors = {};
            case 11:
            case "end":
...
var render = function render() {
  ...
  return _c("b-modal", {
    ...
    on: {
      ...
      keyup: function keyup($event) {
        return _vm.arabicValueLong(_vm.create.long_name);
      },
      input: function input($event) {
        if ($event.target.composing) return;
