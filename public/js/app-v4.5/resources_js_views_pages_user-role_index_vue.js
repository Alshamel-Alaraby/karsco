        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _this2.showPhoto = "./images/img-1.png";
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (true) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/users", _objectSpread(_objectSpread({}, this.create), {}, {
          ...
          _this4.user_id = res.data.data.id;
          _this4.$emit("created");
          setTimeout(function () {
      ...
      if (file) {
        ...
        if (!this.idDelete) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/media", formDate).then(function (res) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].put("/users/".concat(_this6.user_id), {
              old_media: old_media,
              media: new_media
            }).then(function (res) {
              _this6.images = res.data.data.media ? res.data.data.media : [];
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _this3.getData();
            console.log(_this3.$store.state.auth.allworkflow);
          case 3:
          case "end":
            return _context.stop();
        }
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 5:
              _this15.edit.role_id = userRole.role_id;
              _this15.edit.user_id = userRole.user_id;
              _this15.errors = {};
            case 8:
            case "end":
...
var render = function render() {
  ...
  return _c("div", [_c("employee", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.$bvModal.hide("user-create");
      }
    }
  }, [_vm._v("\n              " + _vm._s(_vm.$t("general.Cancel")) + "\n            ")])], 2)]), _vm._v(" "), _c("b-tabs", {
    attrs: {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Role", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("role")))]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "user_id"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("user")))])], 1)], 1), _vm._v(" "), _c("div", {
    ...
    staticClass: "my-1 mr-2"
  }, [_vm._v(_vm._s(_vm.getCompanyKey("user")))]), _vm._v(" "), _c("multiselect", {
    "class": {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.user_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
    ...
    }, [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.role.name : data.role.name_e) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.user_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.user.name : data.user.name_e) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
