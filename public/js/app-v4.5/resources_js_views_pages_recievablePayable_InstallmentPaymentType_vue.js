...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    model: {
      ...
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "auto_freq", $$v);
      },
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.auto_freq ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("installment_payment_auto_freq")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.is_partially ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.auto_freq ? _c("td", [_c("span", {
      "class": [data.auto_freq == 1 ? "text-success" : "text-danger", "badge"]
    }, [_vm._v("\n                      " + _vm._s(data.auto_freq == 1 ? "".concat(_vm.$t("general.Active")) : "".concat(_vm.$t("general.Inactive"))) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.is_partially ? _c("td", [_c("span", {
      ...
      "class": {
        "is-invalid": _vm.$v.edit.auto_freq.$error || _vm.errors.auto_freq,
        "is-valid": !_vm.$v.edit.auto_freq.$invalid && !_vm.errors.auto_freq
      },
      attrs: {
        id: "edit-11"
      }
      ...
      model: {
        value: _vm.$v.edit.auto_freq.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.auto_freq, "$model", $$v);
        },
        expression: "$v.edit.auto_freq.$model"
      }
    }, [_vm._v(_vm._s(_vm.$t("general.Yes")))]), _vm._v(" "), _c("b-form-radio", {
      staticClass: "d-inline-block m-1",
      attrs: {
