...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      Tooltip: "",
      mouseEnter: "",
      invisibleColumns: ["id", "company_id", 'is_admin', "deleted_at", "created_at", "updated_at", "email_verified_at", "remember_token", "country_id", 'governorate_id', 'city_id', 'bank_id', 'nationality', 'employee_id', 'roletype_id', 'salesman_type_id', 'branch_id', 'store_id', 'role_id', 'user_id', 'hotfield_id', 'workflow_id', 'bank_account_id'],
      create: {
        table_name: "",
        columns: []
      },
  ...
  methods: {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/customTable/".concat(id), _objectSpread(_objectSpread({}, this.edit), {}, {
          company_id: this.company_id
        })).then(function (res) {
