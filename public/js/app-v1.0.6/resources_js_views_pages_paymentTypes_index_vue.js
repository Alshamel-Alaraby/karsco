...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      ...
      } else if (vm.$store.state.auth.work_flow_trees.includes("payment types") || vm.$store.state.auth.work_flow_trees.includes("bank") || vm.$store.state.auth.user.type == 'super_admin') {
        return true;
      } else {
        return vm.$router.push({
          name: "home"
